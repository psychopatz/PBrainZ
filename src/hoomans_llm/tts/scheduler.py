...
from .models import FailureCallback, SpeechCallback, SynthesizedAudio, TTSException
...
class SynthesisQueue:
    ...
    async def start(self) -> None:
        ...
        self._executor = ThreadPoolExecutor(
            ...
            thread_name_prefix="hoomans-piper",
        )
        self._tasks = [
...
class SpeechScheduler:
    ...
    async def start(self) -> None:
        ...
        self._loop_task = asyncio.create_task(self._run(), name="hoomans-speech-scheduler")
